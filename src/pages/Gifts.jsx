            ...
            <div className="container mx-auto px-4 py-20 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        Nếu Chúa muốn, chúng tôi sẽ phân phát tất cả các món quà tặng cho một số nhà thờ Hồi giáo và tổ chức đang cần.
                        </p>

                        {/* Arabic Dua */}
                        <div className="space-y-2">
                            <p className="font-arabic text-lg text-gray-800">
           Xin Allah ban thưởng và ban phước cho bạn
                            </p>
                            <p className="text-gray-600 italic text-sm">
                            Xin Allah ban thưởng cho bạn bằng một cú đá vào mông
                            </p>
                        </div>
                    </motion.div>
                ...
                >
                    <div className="inline-block backdrop-blur-sm bg-white/80 p-6 rounded-2xl border border-rose-100/50 shadow-lg">
                        ...
                        <p className="text-sm text-gray-500">
                            Quét để gửi quà tặng qua Ví điện tử
                        </p>
                    </div>
                </motion.div>
            </div>
